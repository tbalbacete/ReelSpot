 ...
 */
export function instanceOfTvSeriesDetails200Response(value: object): boolean {
    let isInstance = true;
...
export function TvSeriesDetails200ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): TvSeriesDetails200Response {
    ...
    return {
        ...
        'lastEpisodeToAir': !exists(json, 'last_episode_to_air') ? undefined : TvSeriesDetails200ResponseLastEpisodeToAirFromJSON(json['last_episode_to_air']),
